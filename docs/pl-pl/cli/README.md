...
| [5. Skille agenta][ex5] | Skills | Rozszerz Copilota o wyspecjalizowane skille |
...
> [!TIP]
> Nie masz płatnego planu? Zweryfikowani studenci mogą uzyskać GitHub Copilot za darmo przez [GitHub Education][callout-student-plan-education]. Plan **Copilot Student** obejmuje agenta, MCP, przegląd kodu i funkcje Copilot CLI używane w tych warsztatach — dzięki temu ukończysz w nich każde środowisko.
